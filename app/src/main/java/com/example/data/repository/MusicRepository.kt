...
class MusicRepository(private val musicDao: MusicDao) {
    ...
    fun getEqualizerPresets(): List<EqualizerPreset> = listOf(
        EqualizerPreset("Default", listOf(-5f, -4f, 7f, 8f, 12f)),
        EqualizerPreset("Rock", listOf(5f, 3f, -1f, 2f, 4f)),
        EqualizerPreset("Pop", listOf(-1f, 2f, 5f, 1f, 3f)),
        EqualizerPreset("Hip Hop", listOf(6f, 4f, 0f, 2f, 3f)),
        EqualizerPreset("Jazz", listOf(4f, 2f, -1f, 2f, 3f)),
        EqualizerPreset("Flat", listOf(0f, 0f, 0f, 0f, 0f)),
        EqualizerPreset("Dance", listOf(6f, 4f, 1f, 4f, 2f)),
        EqualizerPreset("Acoustic", listOf(3f, 2f, 1f, 3f, 2f)),
        EqualizerPreset("Electronic", listOf(5f, 3f, -1f, 3f, 5f))
    )
}
